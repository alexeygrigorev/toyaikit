...
class TestPricingConfig:
    ...
    def test_list_all_models_with_no_provider_filter(self):
        """Test listing models with no provider filter"""
    ...
    def test_list_all_models_with_wrong_provider_filter(self):
        ...
        result = self.pricing_config.list_all_models(
            provider_filter="IamBatman")
